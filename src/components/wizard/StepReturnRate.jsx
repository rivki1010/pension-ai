    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">בחר האם להשתמש בתשואה מדוחות בפועל או בהנחה ידנית.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">בחר תשואה שנתית משוערת.</p>
          </div>
