  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-2xl font-bold text-foreground font-rubik">פרטים אישיים + חיבור AI</h2>
          <p className="text-muted-foreground text-sm">כאן מגדירים פעם אחת פרופיל וגם מפתח API אישי.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-2xl border border-border/50 p-6 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 border-t border-border/50 pt-6">
          <div className="space-y-2">
            <Label>
              שנת לידה <span className="text-destructive">*</span>
            </Label>
            <Input
              type="number"
              placeholder="1985"
          ...
          <div className="space-y-2">
            <Label>
              שכר ברוטו חודשי (₪) <span className="text-destructive">*</span>
            </Label>
            <Input
              type="number"
              placeholder="15,000"
